...
const EditProfileScreen = ({navigation}) => {
  ...
  const withAxios = async () => {
    ...
    formData.append('email', 'q.q@gmail.com');
    formData.append('first_name', 'nour');
    formData.append('last_name', 'nour');
    formData.append('phone_number', 1111111);
    formData.append('description', 'hhwith photo sssssssss hhhhh');

    console.log(formData);
    axios({
      method: 'put',
      url: 'https://hassmalie.herokuapp.com/api/workers/' + userId + '/',
      data: formData,
    })
      .then(Res => {
  ...
  const submitUpdate = () => {
    console.log('data submited hahahahaa');
  };
